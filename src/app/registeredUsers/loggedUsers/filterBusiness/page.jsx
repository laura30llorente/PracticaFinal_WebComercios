// COMPONENTE PARA FILTRAR COMERCIOS POR CIUDAD, ACTIVIDAD Y NOMBRE DE COMERCIO
...
// Definimos el componente UserFilterBusiness
function UserFilterBusiness() {
    ...
    const handleSearch = async (e) => {
        ...
        // Verificamos que algun parámetros de búsqueda esté presente
        if (!searchParams.businessName && !searchParams.activity && !searchParams.city) {
            alert('Por favor, ingrese un nombre, una actividad de comercio o una ciudad para buscar.');
            return;
        }
        ...
        // Añadimos los parametros a buscar (nombre, ciudad y actividad) al objeto queryParams
    ...
    // Renderizamos la página para buscar comercios por nombre, ciudad y actividad
    return (
        <div className="container mx-auto px-4 py-8">
            {/* Título de la página con estilo de fuente grande y en negrita */}
            <h1 className="text-3xl font-bold text-center mb-10">Buscar Comercios por Nombre, Ciudad y Actividad</h1>
            ...
            <form onSubmit={handleSearch} className="max-w-xl mx-auto">
                ...
                <div className="mb-5">
                    ...
                    <input
                        ...
                        id="businessName"
                        name="businessName"
                        value={searchParams.businessName}   // Guardamos el nombre del comercio en searchParams
...
export default UserFilterBusiness;