// COMPONENTE PARA FILTRAR COMERCIOS POR ID
...
// Definimos el componente SeeBusinessByIDPage
function SeeBusinessByIDPage() {
    ...
    // Renderizamos la página para buscar comercios por ID
    return (
        <div className="container mx-auto px-4 py-8">
            {/* Título de la página con estilo de fuente grande y en negrita */}
            <h1 className="text-3xl font-bold text-center mb-10">Buscar Comercios por ID</h1>
            ...
            <form onSubmit={handleSearch} className="max-w-xl mx-auto">
                ...
                <div className="mb-5">
                    ...
                    <input
                        ...
                        id="businessID"
                        name="businessID"
                        value={searchParams.businessID}   // Guardamos el ID del comercio introducido en searchParams
...
export default SeeBusinessByIDPage;